...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
      <motion.div 
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-linear-to-br from-cyan-500 to-cyan-700 rounded-full blur-3xl opacity-20"></div>
          <div className="absolute bottom-0 left-0 w-80 h-80 bg-linear-to-tr from-cyan-400 to-cyan-600 rounded-full blur-3xl opacity-20"></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="relative h-96 md:h-125 flex items-center justify-center"
            >
              <div className="absolute inset-0 bg-linear-to-br from-cyan-300 to-cyan-600 rounded-3xl blur-2xl opacity-30"></div>
